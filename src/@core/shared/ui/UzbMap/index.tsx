...
export const UzbMap: FC = () => {
  ...
  const handleColor = useCallback((e: any) => {
    if (svgRef.current?.children) {
      for (let i = 0; i < svgRef.current?.children.length; i++) {
        if (svgRef.current?.children[i].classList.contains("activeMap")) {
          svgRef.current?.children[i].classList.remove("activeMap");
        }
        if (svgRef.current?.children[i]?.id === e.target?.id) {
          svgRef.current?.children[i].classList.add("activeMap");
        }
      }
    }
  ...
  // handleWarningColor
  const handleWarningColor = useCallback(async () => {
    const res = await getWarning();
    for (let i = 0; i < svgRef.current?.children.length; i++) {
      for (let j = 0; j < res?.data?.length; j++) {
        if (
          svgRef.current?.children[i].getAttribute("id") === res?.data[j]?.id
        ) {
          svgRef.current?.children[i].setAttribute(
            "data-percentage",
            res?.data[j]?.percentage
          );
          if (
            svgRef.current?.children[i].getAttribute("data-percentage") > 50 &&
            svgRef.current?.children[i].getAttribute("data-percentage") < 70
          ) {
            svgRef.current?.children[i].classList.add("warningColor_medium");
            svgRef.current?.children[i].classList.remove("warningColor_high");
          } else if (
            svgRef.current?.children[i].getAttribute("data-percentage") > 70 &&
            svgRef.current?.children[i].getAttribute("data-percentage") <= 100
          ) {
            svgRef.current?.children[i].classList.add("warningColor_high");
            svgRef.current?.children[i].classList.remove("warningColor_medium");
          } else {
            svgRef.current?.children[i].classList.remove("warningColor_high");
            svgRef.current?.children[i].classList.remove("warningColor_medium");
          }
      ...
      >
        <Tooltip label="Андижон вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Andijon_viloyati}
          />
        </Tooltip>

        <Tooltip label="Бухоро вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Buxoro_viloyati}
          />
        </Tooltip>

        <Tooltip label="Фарғона вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Fargona_viloyati}
          />
        </Tooltip>

        <Tooltip label="Джиззах вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Jizzax_viloyati}
          />
        </Tooltip>

        <Tooltip label="Наманган вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Namangan_viloyati}
          />
        </Tooltip>

        <Tooltip label="Навоий вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Navoiy_viloyati}
          />
        </Tooltip>

        <Tooltip label="Қашқадарё вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Qashqadaryo_viloyati}
          />
        </Tooltip>

        <Tooltip label="Қорақалпоғистон республикаси">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Qoraqalpogiston_respublikasi}
          />
        </Tooltip>

        <Tooltip label="Самарқанд вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Samarqand_viloyati}
          />
        </Tooltip>

        <Tooltip label="Сирдарё вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Sirdaryo_viloyati}
          />
        </Tooltip>

        <Tooltip label="Сурхондарё вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Surxondaryo_viloyati}
          />
        </Tooltip>

        <Tooltip label="Тошкент шахри">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Toshkent_shahar}
          />
        </Tooltip>

        <Tooltip label="Тошкент вилояти">
          <path
            ...
            fill="#F7F9FA"
            stroke="#DADFDD"
            id={regionsId.Toshkent_viloyati}
          />
        </Tooltip>

        <Tooltip label="Хоразм вилояти">
          <path
